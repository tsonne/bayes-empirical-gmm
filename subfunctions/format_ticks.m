...
%                  (Can use [] or not specify to ignore) Default = 0.0
%                  Can also be vector: [xtick_vert_off ytick_hor_off]
%
%Optional Inputs:%                
...
%
% 2017-06-27 tsonne: Enabled separate x- and y-label offset values,
%   give 'offset' as 2-element vector if desired.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% BEGIN FUNCTION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% TS 20170627: enable separate x- and y-offsets
if length(offset)==1
    offsetx = offset;
    offsety = offset;
else
...
txpos = lim(1)-offsetx*(lim(2)-lim(1)); % TS 20170627
if rotx == 0;
    if latex_on;
        hx = text(tickposx,...
            repmat(txpos,length(tickposx),1),...
...
%    set(h,'XTick',tickposx);
    ...
    txpos = lim(1)-offsety*(lim(2)-lim(1));  % TS 20170627
    if roty == 0;
        if latex_on;
            hy = text(...
                repmat(txpos,length(tickposy),1),...
                tickposy,...
